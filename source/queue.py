...
class LinkedQueue(object):
    ...
    def enqueue(self, item):
        ...
        Running time: O(1) – Constant time to add to tail, already have reference to it"""
    ...
    def dequeue(self):
        ...
        Running time: O(1) – Both operations only change first item in list"""
        if self.is_empty():
...
class ArrayQueue(object):
    ...
    def enqueue(self, item):
        ...
        to the end of the list which is a constant time operation. [TODO]"""
        self.list.append(item)
